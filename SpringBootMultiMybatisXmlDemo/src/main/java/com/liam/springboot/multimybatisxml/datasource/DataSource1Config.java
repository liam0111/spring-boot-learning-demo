package com.liam.springboot.multimybatisxml.datasource;
 ...
 */
@Configuration
@MapperScan(basePackages = "com.liam.springboot.multimybatisxml.mapper.one", sqlSessionTemplateRef = "oneSqlSessionTemplate")
